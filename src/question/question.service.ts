...
export class QuestionService {
  ...
  async saveAfterStream(data: {
    ...
    const { question, answer, childId, conversationId, audioUrl, imageUrl } = data;
    ...
    console.log('Conversation saved immediately');
    // const audioFile = await this.aiService.textToSpeech(answer);
    // let imageUrl = '';
    // const shouldGenerate = await this.aiService.shouldGenerateImage(question);
    // if (shouldGenerate) {
    //   imageUrl = await this.aiService.generateImage(question);
    // }
    ...
    //   },
    // });
    console.log('Saved after stream');
  }
}
